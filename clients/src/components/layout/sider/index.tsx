          ...
          >
            <ListItemButton
              ...
              sx={{
                ...
                "&.Mui-selected": {
                  "&:hover": {
                    backgroundColor: isSelected ? '#1e36e8' : "transparent", //provides color in the sidenav while hovering
                  },
                  backgroundColor: isSelected ? '#475be8' : "transparent",  //provides color in the sidenav without hovering
                },
                justifyContent: "center",
                margin : '10px auto',
                borderRadius: '12px',
